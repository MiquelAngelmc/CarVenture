...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void _calculateCost(Vehicle vehicle) {
  ...
  void _confirmBooking(Vehicle vehicle) async {
    if (_formKey.currentState!.validate() &&
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Reserva confirmada")));
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                validator: (value) =>
                    _startDate == null ? "Seleccione una fecha" : null,
              ...
              TextFormField(
                ...
                validator: (value) =>
                    _endDate == null ? "Seleccione una fecha" : null,
                controller: TextEditingController(
                    text: _endDate != null
