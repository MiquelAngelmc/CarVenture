...
class VehicleDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Image.network(vehicle.imageUrl, height: 200, width: double.infinity, fit: BoxFit.cover),
          Text("${vehicle.brand} ${vehicle.model}", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
